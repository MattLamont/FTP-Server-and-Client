g++ -I /usr/include server.cpp TCPServer.h TCPServer.cpp TCPServerConnection.h TCPServerConnection.cpp -o server -lboost_system -pthread -L /usr/lib64 -L /usr/lib/libboost_thread-mt.so;
